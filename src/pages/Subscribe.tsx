...
const tiers: Tier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Pro tier color on your username",
      "Custom profile + video border colors",
      "Promote your own ads at member rates",
      "Priority feed placement for your posts",
      "Cancel anytime",
    ],
    highlight: true,
    cta: "Choose Pro",
  },
  {
    ...
    features: [
      ...
      "Custom username gradient + icon",
      "Override your tier color",
